<template>
  <div id="searchPage">
    <div class="search">
      ...
      />
      <button class="searchButton" href="#" v-on:click="searchWeather">
    ...
    <div class="weatherContainer">
      <div class="weatherList" v-if="$store.state.forecast">
        ...
        <p v-if="this.forecastTemperatureF">
          {{ this.forecastTemperatureF + "&#176;F" }}
        </p>
...
export default {
  ...
  methods: {
    searchWeather() {
      WeatherService.getWeatherByPostalCode(this.search)
        .then((response) => {
